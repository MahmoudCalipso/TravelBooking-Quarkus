...
public class WebAccommodationController {

        private static final Logger log = LoggerFactory.getLogger(WebAccommodationController.class);
        ...
        public Response searchAccommodations(
                ...
                try {
                        log.info("Search accommodations request - city: {}, country: {}, type: {}", city, country,
                                        type);
        ...
        public Response getAccommodationById(@PathParam("accommodationId") UUID accommodationId) {
                try {
                        ...
                        AccommodationResponse accommodation = accommodationService
                        ...
                        return Response.ok()
                                        .entity(new SuccessResponse<>(accommodation,
        ...
        public Response checkAvailability(
                ...
                try {
                        log.info("Check availability request for accommodation: {}, dates: {} to {}", accommodationId,
                                        checkIn,
                                        checkOut);
        ...
        public Response findNearbyAccommodations(
                        ...
                        @QueryParam("pageSize") @DefaultValue("20") int pageSize) {
                try {
                        log.info("Find nearby accommodations request - lat: {}, lng: {}, radius: {}km", latitude,
                                        longitude,
                                        radiusKm);
        ...
        public Response createAccommodation(@Context SecurityContext securityContext,
                ...
                try {
                        ...
                        AccommodationResponse accommodation = accommodationService.createAccommodation(
        ...
        public Response uploadImage(
                ...
                try {
                        String supplierId = securityContext.getUserPrincipal().getName();
                        log.info("Upload image request for accommodation: {} by supplier: {}", accommodationId,
                                        supplierId);

                        accommodationService.addImage(UUID.fromString(supplierId), accommodationId, imageUrl, caption,
                                        isPrimary);
        ...
        public Response removeImage(
                ...
                try {
                        String supplierId = securityContext.getUserPrincipal().getName();
                        log.info("Remove image request: {} from accommodation: {} by supplier: {}", imageId,
                                        accommodationId,
                                        supplierId);
        ...
        public Response updateAvailability(
                ...
                try {
                        String supplierId = securityContext.getUserPrincipal().getName();
                        log.info("Update availability request for accommodation: {} on date: {}", accommodationId,
                                        date);

                        accommodationService.updateAvailability(UUID.fromString(supplierId), accommodationId, date,
                                        isAvailable,
                                        priceOverride);
        ...
        public Response getAnalytics(
                ...
                try {
                        String supplierId = securityContext.getUserPrincipal().getName();
                        log.info("Get analytics request for accommodation: {} by supplier: {}", accommodationId,
                                        supplierId);
