...
public class AdminAnalyticsController {
    ...
    public Response getAccommodationStatistics(
        ...
        try {
            ...
            AdminAnalyticsService.AccommodationAnalytics statistics = adminAnalyticsService.getAccommodationAnalytics();
    ...
    public Response getRevenueReports(
        ...
        try {
            ...
            AdminAnalyticsService.RevenueAnalytics revenue = adminAnalyticsService.getRevenueAnalytics(resolvedStart,
                    resolvedEnd);
