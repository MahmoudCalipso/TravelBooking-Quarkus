...
public class WebBookingController {
        ...
        private static final Logger log = LoggerFactory.getLogger(WebBookingController.class);
        ...
        public Response processPayment(
                ...
                try {
                        ...
                        bookingService.processPayment(UUID.fromString(userId), bookingId, transactionId);
        ...
        public Response getPaymentStatus(
                ...
                try {
                        ...
                        return Response.ok()
                                        .entity(new SuccessResponse<>(paymentStatus,
