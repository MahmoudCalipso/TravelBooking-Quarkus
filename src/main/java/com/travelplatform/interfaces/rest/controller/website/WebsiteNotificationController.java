...
/**
 * Website booking notification endpoints.
 */
@Path("/api/v1/website-booking/notifications")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
@RolesAllowed({"SUPPLIER_SUBSCRIBER", "TRAVELER", "ASSOCIATION_MANAGER"})
public class WebsiteNotificationController extends NotificationController {
}
