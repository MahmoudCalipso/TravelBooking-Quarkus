...
public class WebChatController {
        ...
        public Response getChatGroupMessages(
                ...
                try {
                        ...
                        var messages = chatService.getChatGroupMessages(UUID.fromString(userId), groupId, page,
                                        pageSize);
        ...
        public Response getConversationMessages(
                ...
                try {
                        String userId = securityContext.getUserPrincipal().getName();
                        log.info("Get conversation messages request for conversation: {} by user: {}", conversationId,
                                        userId);

                        var messages = chatService.getConversationMessages(UUID.fromString(userId), conversationId,
                                        page, pageSize);
                        PageResponse<MessageResponse> response = buildPageResponse(messages, page, pageSize);
        ...
        public Response sendDirectMessage(
                ...
                try {
                        ...
                        UUID conversationId = chatService.getOrCreateConversation(UUID.fromString(senderId),
                                        recipientId);
                        MessageResponse messageResponse = chatService.sendDirectMessage(UUID.fromString(senderId),
                                        conversationId,
                                        message);
        ...
        public Response markMessagesAsRead(
                ...
                try {
                        String userId = securityContext.getUserPrincipal().getName();
                        log.info("Mark messages as read request for conversation: {} by user: {}", conversationId,
                                        userId);
        ...
        public Response getUnreadCount(@Context SecurityContext securityContext) {
                try {
                        ...
                        return Response.ok()
                                        .entity(new SuccessResponse<>(unreadCount,
